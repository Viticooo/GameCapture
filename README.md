...
**[ES]** 
¿Cansado de configurar software pesado como OBS o PotPlayer solo para jugar tu Nintendo Switch en el monitor? **GameCapture** es una aplicación de escritorio *plug-and-play* diseñada para hacer una sola cosa a la perfección: mostrar tu capturadora USB en pantalla completa con cero retraso (*input lag*).
...
git clone [https://github.com/Viticooo/GameCapture.git](https://github.com/Viticooo/GameCapture.git)
